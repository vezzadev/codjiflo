...
describe('VirtualizedSideBySideDiffView', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders virtualized list container', () => {
    render(<VirtualizedSideBySideDiffView {...defaultProps} />);
  ...
  it('filters lines when contentFilter is left', () => {
    render(<VirtualizedSideBySideDiffView {...defaultProps} contentFilter="left" />);
  ...
  it('filters lines when contentFilter is right', () => {
    render(<VirtualizedSideBySideDiffView {...defaultProps} contentFilter="right" />);
  ...
  it('calls onStartComment with correct side when clicking left pane comment button', () => {
    ...
    render(<VirtualizedSideBySideDiffView {...defaultProps} onStartComment={onStartComment} />);
  ...
  it('renders with empty aligned lines', () => {
    render(<VirtualizedSideBySideDiffView {...defaultProps} alignedLines={[]} />);

    expect(screen.getByTestId('virtualized-sxs-list')).toBeInTheDocument();
  });

  it('renders with showWhitespace enabled', () => {
    render(<VirtualizedSideBySideDiffView {...defaultProps} showWhitespace={true} />);
