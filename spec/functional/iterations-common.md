# Iteration Management Specification - Common Concepts

This document covers shared concepts for iteration management that apply to both Stateful and Stateless modes. For mode-specific details, see:
- [iterations-stateful.md](./iterations-stateful.md) - GitHub Action + Artifact approach
- [iterations-stateless.md](./iterations-stateless.md) - Timeline API + Web Worker approach
...
GitHub lacks native iteration support. CodjiFlo implements iterations via:
- **Stateful Mode**: GitHub Action + Artifact (see [iterations-stateful.md](./iterations-stateful.md))
- **Stateless Mode**: Timeline API + Web Worker (see [iterations-stateless.md](./iterations-stateless.md))
